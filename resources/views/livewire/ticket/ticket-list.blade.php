                            ...
                            <div class="flex gap-3.5">
                                <div
                                    ...
                                    <button
                                        ...
                                        style="@if(empty($filterType))background-color:#3b82f6;color:white;@else background-color:white;color:#6b7280;@endif"
                                    >Todos</button>
                                    <button
                                        wire:click="$set('filterType', 'solved')"
                                        class="text-theme-sm h-10 rounded-md px-3 py-2 font-medium transition-colors"
                                        style="@if($filterType==='solved')background-color:#3b82f6;color:white;@else background-color:white;color:#6b7280;@endif"
                                    >Solucionados</button>
                                    <button
                                            ...
                                            class="absolute top-1/2 left-4 -translate-y-1/2 text-gray-500 dark:text-gray-400"><svg
                                                class="fill-current" width="20" height="20" viewBox="0 0 20 20"
                                                    ...
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        ...
                                                        fill=""></path>
                                                </svg></span><input type="text" placeholder="Search..." wire:model.live="search"
