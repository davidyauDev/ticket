    ...
    <div class="my-6">
        ...
        @forelse ($topTechnicians as $technician)
            <div class="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-800">
                ...
                <span class="text-right text-gray-500 text-theme-sm dark:text-gray-400">{{ $technician['total_tickets'] }}</span>
            </div>
        @empty
    ...
    <p class="text-gray-700 text-theme-sm dark:text-gray-400">
        <a href="{{ route('tickets.show', $call['id']) }}"
           class="text-blue-500 hover:underline">
            TCK-{{ str_pad($call['id'], 11, '0', STR_PAD_LEFT) }}
        </a>
    </p>
</td>
                                    ...
                                    <span class="text-gray-400 text-sm italic">{{ $call['comentario'] }}</span>
                                </div>
                            @endforeach
                        </div>
                    </div>
