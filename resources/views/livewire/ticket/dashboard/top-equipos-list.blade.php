<div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
    ...
    <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Equipos</h3>
        <!-- Selector de Mes -->
    ...
    <div class="my-6">
        <div class="flex items-center justify-between pb-4 border-b border-gray-100 dark:border-gray-800">
            <span class="text-gray-400 text-theme-xs"> Nombre </span>
            <span class="text-right text-gray-400 text-theme-xs"> Cantidad </span>
        </div>
        @forelse ($topEquipos as $equipo)
            <div class="flex items-center justify-between py-3 border-b border-gray-100 dark:border-gray-800">
                <span class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $equipo['name'] }}</span>
                <span class="text-right text-gray-500 text-theme-sm dark:text-gray-400">{{ $equipo['total_tickets'] }}</span>
            </div>
        @empty
