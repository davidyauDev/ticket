            ...
            <div class="rounded-xl border bg-white ">
                ...
                <div class="px-6 pb-6">
                    <div
                        ...
                        <div class="flex items-start gap-3">
                            <div class="-mt-0.5 text-success-500"><svg width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">Este ticket ha sido cerrado y no
                                    puede ser modificado.</p>
                                <!---->
                            </div>
                        </div>
                    </div>
                ...
                <div class="px-6 pb-6">
                    <div
                        ...
                        <div class="flex items-start gap-3">
                            <div class="-mt-0.5 text-blue-light-500"><svg width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <div>
                                <h4 class="mb-1 text-sm font-semibold text-gray-800 dark:text-white/90">Informacin del
                                    Mensaje </h4>
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    No puedes actualizar este ticket porque no está asignado a ti.</p>
                                <!---->
                            </div>
                        </div>
                    </div>
