<div>
    ...
    <div class="mb-4 flex justify-between items-center gap-4">
        ...
        <button wire:click="crearUsuario" icon="plus" variant="primary">Agregar Nuevo Usuario</button>
    </flux:modal.trigger>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td class="px-4 py-2 font-medium text-gray-900 dark:text-white">#428</td>
                    ...
                    <td class="px-6 py-4 flex items-center">
                        <flux:modal.trigger name="edit-profile">
                        <button wire:click="editarUsuario({{ $user->id }})" icon="plus" variant="primary">Editar</button>
                        </flux:modal.trigger>
