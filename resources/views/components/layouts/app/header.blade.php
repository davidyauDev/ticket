<header
  ...
  class="sticky top-0 z-9 flex w-full border-gray-200 bg-white lg:border-b dark:border-gray-800 dark:bg-gray-900"
>
   <div
  ...
  >
    ...
    >
     ...
     <button
      ...
      <button @click="menuToggle = !menuToggle" class="lg:hidden ...">
